...
def upgrade() -> None:
    ...
    op.execute(
        "INSERT INTO cdr_product_ticket (product_id, name, max_use, expiration) SELECT id, name_fr, ticket_max_use, ticket_expiration FROM cdr_product WHERE generate_ticket==True",
    )
...
def downgrade() -> None:
    ...
    op.drop_table("cdr_product_ticket")
    # ### end Alembic commands ###
