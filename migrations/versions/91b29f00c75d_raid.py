...
def upgrade() -> None:
    ...
    sa.Column('bike_size', sa.Enum('XS', 'S', 'M', 'L', 'XL', name='size'), nullable=True, default=None),
    sa.Column('t_shirt_size', sa.Enum('XS', 'S', 'M', 'L', 'XL', name='size'), nullable=True, default=None),
