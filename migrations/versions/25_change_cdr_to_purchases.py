...
def upgrade() -> None:
    ...
    op.create_table('purchases_checkout_paid_product',
        sa.Column('user_id', sa.String(), nullable=False),
        sa.Column('product_variant_id', sa.Uuid(), nullable=False),
        sa.Column('checkout_id', sa.Uuid(), nullable=False),
        sa.ForeignKeyConstraint(['checkout_id'], ['purchases_checkout.id'], ),
        sa.ForeignKeyConstraint(['product_variant_id'], ['purchases_product_variant.id'], ),
        sa.ForeignKeyConstraint(['user_id'], ['core_user.id'], ),
        sa.PrimaryKeyConstraint('user_id', 'product_variant_id')
    )
    op.add_column('purchases_product_variant', sa.Column('needs_validation', sa.Boolean(), nullable=False))
