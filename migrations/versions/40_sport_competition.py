...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("athlete_cameraman_quota", sa.Integer(), nullable=True),
        sa.Column("athlete_pompom_quota", sa.Integer(), nullable=True),
        sa.Column("athlete_fanfare_quota", sa.Integer(), nullable=True),
        sa.Column("non_athlete_cameraman_quota", sa.Integer(), nullable=True),
        sa.Column("non_athlete_pompom_quota", sa.Integer(), nullable=True),
        sa.Column("non_athlete_fanfare_quota", sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(["edition_id"], ["competition_edition.id"]),
        sa.ForeignKeyConstraint(
            ["school_id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["team_id"], ["competition_team.id"]),
        sa.PrimaryKeyConstraint("sport_id", "edition_id", "team_id"),
    )
    op.create_table(
        "competition_product",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "school_type",
            sa.Enum(ProductSchoolType, name="productschooltype"),
            nullable=False,
        ),
        sa.Column(
            "public_type",
...
def downgrade() -> None:
    ...
    sa.Enum(ProductSchoolType, name="productschooltype").drop(op.get_bind())
    # ### end Alembic commands ###
