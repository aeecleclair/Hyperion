...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("myeclpay_transaction", "signature")
    op.drop_column("myeclpay_transaction", "qr_code_store")
    op.drop_column("myeclpay_transaction", "qr_code_key")
    op.drop_column("myeclpay_transaction", "qr_code_iat")
    op.drop_column("myeclpay_transaction", "qr_code_tot")
