...
Create Date: 2024-05-22 23:46:33.079493
"""
...
revision: str = "8776a2bb86f0"
down_revision: str | None = "a92c02b47da4"
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_raid_participant_checkout_id"), table_name="raid_participant_checkout"
    )
