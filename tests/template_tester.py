...
file_migration_mail_already_used = Path(
    "./test_outputs/test_migration_mail_already_used.html",
)
...
file_reset_mail_does_not_exist = Path(
    "./test_outputs/test_reset_mail_does_not_exist.html",
)
