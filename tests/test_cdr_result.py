...
def test_construct_dataframe_from_users_purchases():
    ...
    assert df.columns.tolist() == [
        ...
        "Surnom",
        "Email",
        f"{product1.name_fr} : {product1_variant1.name_fr}",
        f"{product1.name_fr} : {product1_variant2.name_fr}",
        f"{product1.name_fr} : {product1_variant3.name_fr}",
        f"{product1.name_fr} : {customdata_field1.name}",
        f"{product2.name_fr} : {product2_variant1.name_fr}",
        f"{product2.name_fr} : {customdata_field2.name}",
        "Panier payé",
        "Commentaire",
    ]
