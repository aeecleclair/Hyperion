...
# ---------------------------------------------------------------------------
# Union discriminée — point d'entrée unique pour le parsing
# ---------------------------------------------------------------------------
...
def parse_webhook(data: dict) -> DocumensoWebhook:
    """Parse un payload brut reçu en webhook Documenso.

    Exemple d'utilisation :
        import json
        from documenso_webhooks import parse_webhook
        ...
        match webhook.event:
            case WebhookEvent.DOCUMENT_COMPLETED:
                handle_completed(webhook.payload)
            case WebhookEvent.DOCUMENT_REJECTED:
                handle_rejected(webhook.payload)
    """
