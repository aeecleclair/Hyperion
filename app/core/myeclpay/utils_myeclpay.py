...
def structure_model_to_schema(
    ...
    """
    return schemas_myeclpay.Structure(
        id=structure.id,
...
def refund_model_to_schema(
    refund: models_myeclpay.Refund,
) -> schemas_myeclpay.Refund:
    """
    Convert a refund model to a schema.
    """
    return schemas_myeclpay.Refund(
        id=refund.id,
...
def invoice_model_to_schema(
    invoice: models_myeclpay.Invoice,
) -> schemas_myeclpay.Invoice:
    """
    Convert an invoice model to a schema.
    """
    return schemas_myeclpay.Invoice(
        id=invoice.id,
        ...
        details=[
            schemas_myeclpay.InvoiceDetail(
